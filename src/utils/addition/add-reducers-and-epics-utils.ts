...
function addReducersAndEpicsToStore (context: AddReducersAndEpicsContext, host: Tree): Change[] {
...
export function addReducersAndEpicsRule (options: ModuleOptions): Rule {
    return (host: Tree) => {
        let context = createAddReducersAndEpicsContext(options);
        let storeChanges = addReducersAndEpicsToStore(context, host);
